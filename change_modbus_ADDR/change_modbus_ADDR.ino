...
byte new_ADDR = 0x51;
byte WRITE_REG = 0x06;
byte unlockMaster[] = {prev_ADDR, WRITE_REG, 0x00, 0x69, 0xB5, 0x88, 0x22, 0xA1};
byte changeADDR[] = {prev_ADDR, WRITE_REG, 0x00, 0x1a, 0x00, new_ADDR, 0x64, 0x70};
byte saveConfig[]={new_ADDR, WRITE_REG, 0x00, 0x00, 0x00, 0x00, 0x84, 0x4B};

byte accCalmode[]={new_ADDR, WRITE_REG, 0x00, 0x01, 0x00, 0x01, 0x14, 0x4B};
byte setNormal[]={new_ADDR, WRITE_REG, 0x00, 0x01, 0x00, 0x00, 0xD5, 0x8B};

byte readAngle[] = {new_ADDR, 0x03, 0x00, 0x3d, 0x00, 0x03, 0x99, 0x86};
byte readAcc[] = {new_ADDR, 0x03, 0x00, 0x34, 0x00, 0x03, 0x49, 0x84};
byte readAngVel[] = {new_ADDR, 0x03, 0x00, 0x37, 0x00, 0x03, 0xB9, 0x84};
byte recData[12];
byte trashBuffer[70];
